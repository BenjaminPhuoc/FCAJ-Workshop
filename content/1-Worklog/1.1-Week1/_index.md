...
### Week 1 Objectives
* Attend orientation with AWS Vietnam and receive AWS Enterprise account access.
* Divide tasks within the 2-member team and set up individual local development environments (AWS CLI, IAM permissions).
...
| Fri | - Hands-on practice: Executed `aws configure` to connect to the Singapore region (`ap-southeast-1`).<br>- Successfully launched an EC2 instance and SSHed into it. | 06/05/2026 | 06/05/2026 | [AWS Study Group Portal](https://cloudjourney.awsstudygroup.com/) |

### Key Achievements
* Successfully configured a secure Local Terminal environment connected to AWS without exposing Access Keys.
* Finalized project roadmap and shared GitHub repository with team.
